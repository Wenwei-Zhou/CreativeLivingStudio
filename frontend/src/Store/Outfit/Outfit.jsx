...
import outfitBackground from "images/outfitBackground.png"
import "./Outfit.css"
...
export const Outfit = () => {
    ...
    const firebaseConfig = {
      ...
      useEffect(() => {
        ...
        const fetchProduct = async () => {
            ...
            const querySnapshot = await getDocs(collection(db, "outfit"));
    ...
    return(
        <div className="outfit">
            {/* <Navbar/>
            <img src={outfitBackground} alt="outfitBackground" width="100%" height="580"/> */}
            ...
            <img src={outfitBackground} alt="outfitBackground" width="100%" height="580px"/>
            </div>
